use crate::pb::getting::v1::{auth_server::Auth, SigninRequest, SigninResponse, SignupRequest, SignupResponse, TokenType};
...
impl Auth for AuthService {
    async fn signin(
        ...
        let resp = SigninResponse { access_token: "".to_string(), token_type: TokenType::Bearer as i32 };
